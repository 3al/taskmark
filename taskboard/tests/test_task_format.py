...
# «Чеклист» сюда не входит: он план под конкретную работу, а не часть эталона —
# заводит его агент, когда работа многошаговая
SECTIONS = ("## Описание", "### Критерии приёмки",
            "## Комментарии", "## История коммитов")
